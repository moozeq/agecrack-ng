...
def extract_proteins(filenames: List[str], extract_filter: str, excluded_species: List[str]) -> (
List[str], Dict[str, List[str]]):
    """
    From provided filenames extract proteins based on ``extract_filter`` word.
